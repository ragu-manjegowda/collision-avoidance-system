...
// detects objects in an image using the YOLO library and a set of pre-trained objects
// from the COCO database; a set of 80 classes is listed in "coco.names" and pre-trained
// weights are stored in "yolov3.weights"
                   ...
                   bool bVis)
{
    ...
    vector<int> outLayers =
        net.getUnconnectedOutLayers();  // get  indices of  output layers, i.e.  layers
    ...
    for (auto it = indices.begin(); it != indices.end(); ++it)
    {
        ...
        bBox.boxID =
            (int)bBoxes.size();  // zero-based unique identifier for this bounding box
